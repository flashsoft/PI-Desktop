...
sklm: {
    ...
    remoteHosts: {
      ...
      pairTitle: "配对新主机",
      pairBody: "如果你已自行运行 pi-host：粘贴它的 RACP 地址和启动输出中的配对令牌。",
      pair: "配对",
      pairing: "配对中…",
      pairAction: "添加",
      ...
      fieldUrl: "RACP 地址",
      fieldUrlDesc:
        "pi-host 的回环端点，例如 ws://127.0.0.1:9443/v1/racp/ws（经 SSH 转发）。适用于你自己启动的主机；下面的 SSH 安装会替你完成这一步。",
      fieldPairingToken: "配对令牌",
      fieldPairingTokenDesc:
        "来自 pi-host 引导输出的一次性 ppt1.* 令牌，配对后即消耗。",
      sshTitle: "在服务器上安装（SSH）",
      sshBody:
        "PI-Desktop 会在你已能用 ssh 登录的机器上安装 pi-host，并保持一条回环隧道。认证沿用你自己的 ssh 配置与 agent；也可以用登录密码代替密钥。",
      sshHost: "SSH 主机",
      sshHostDesc: "主机名或地址，按 ssh 的原样传入。",
      sshHostPlaceholder: "build-box.local",
      sshUser: "用户",
      sshUserDesc: "登录用户；留空则使用本机用户名。",
      sshPort: "SSH 端口",
      sshPortDesc: "留空使用 ssh 默认值（22）。",
      sshIdentityFile: "私钥文件",
      sshIdentityFileDesc: "私钥路径；留空则由 agent 与 ~/.ssh/config 决定。",
      sshAuthMode: "认证方式",
      sshAuthModeDesc: "使用你自己的 SSH 密钥或 agent，也可以改用密码认证。",
      sshAuthKey: "SSH 密钥",
      sshAuthPassword: "密码",
      sshPassword: "密码",
      sshPasswordDesc: "通过 askpass 助手交给 ssh 客户端，不会出现在命令行上。",
      sshPasswordPlaceholder: "你的登录密码",
      sshShowPassword: "显示密码",
      sshHidePassword: "隐藏密码",
      sshPasswordStored: "保存在系统钥匙串中，主机在重启后也能重新连接。",
      sshAction: "安装并配对",
      sshActionHint: "在目标主机上安装 pi-host，并与本桌面配对。",
      sshRunning: "安装中…",
      sshSucceeded: "已安装并配对 {{label}}。",
