...
sklm: {
    ...
    remoteHosts: {
      ...
      pairBody: "Kendinizin çalıştırdığı bir pi-host için: RACP URL'sini ve başlangıç çıktısındaki eşleşme belirtecini yapıştırın.",
      pair: "Eşle",
      pairing: "Eşleşiyor…",
      pairAction: "Ekle",
      ...
      fieldUrl: "RACP URL",
      fieldUrlDesc:
        "pi-host geri döngü uç noktası, örn. ws://127.0.0.1:9443/v1/racp/ws (SSH üzerinden yönlendirilir). Kendiniz başlattığınız bir ana bilgisayar içindir; aşağıdaki SSH kurulumu bunu sizin için yapar.",
      ...
      sshTitle: "Bir sunucuya kurun (SSH)",
      sshBody:
        "PI-Desktop, ssh ile zaten erişebildiğiniz bir makineye pi-host kurar ve ona geri döngü tüneli tutar. Kendi ssh yapılandırmanız ve aracınız geçerlidir; anahtar yerine oturum açma parolası da kullanılabilir.",
      sshHost: "SSH ana bilgisayarı",
      sshHostDesc: "Ana bilgisayar adı veya adresi, ssh'in aldığı haliyle.",
      sshHostPlaceholder: "build-box.local",
      sshUser: "Kullanıcı",
      sshUserDesc: "Oturum açma kullanıcısı; yerel kullanıcı adınızı kullanmak için boş bırakın.",
      sshPort: "SSH bağlantı noktası",
      sshPortDesc: "ssh varsayılanı (22) için boş bırakın.",
      sshIdentityFile: "Kimlik dosyası",
      sshIdentityFileDesc: "Özel anahtar yolu; aracı ve ~/.ssh/config karar versin diye boş bırakın.",
      sshAuthMode: "Kimlik doğrulama",
      sshAuthModeDesc: "Kendi SSH anahtarınızı veya aracınızı kullanın ya da parolayla kimlik doğrulayın.",
      sshAuthKey: "SSH anahtarı",
      sshAuthPassword: "Parola",
      sshPassword: "Parola",
      sshPasswordDesc: "ssh istemcisine askpass yardımcısı üzerinden verilir, komut satırında asla görünmez.",
      sshPasswordPlaceholder: "Oturum açma parolanız",
      sshShowPassword: "Parolayı göster",
      sshHidePassword: "Parolayı gizle",
      sshPasswordStored: "Yeniden başlatmadan sonra bu ana bilgisayarın yeniden bağlanabilmesi için işletim sistemi anahtarlığında saklanır.",
      sshAction: "Kur ve eşle",
      sshActionHint: "pi-host'u ana bilgisayara kurar ve bu masaüstüyle eşler.",
      sshRunning: "Kuruluyor…",
      sshSucceeded: "{{label}} kuruldu ve eşlendi.",
