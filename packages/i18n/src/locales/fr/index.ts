...
sklm: {
    ...
    "remoteHosts": {
      ...
      "pairBody": "Pour un pi-host que vous exécutez vous-même : collez son URL RACP et le jeton d'appariement de sa sortie de démarrage.",
      "pair": "Apparier",
      "pairing": "Appariement…",
      "pairAction": "Ajouter",
      ...
      "fieldUrl": "URL RACP",
      "fieldUrlDesc": "Point d'accès en boucle locale de pi-host, ex. ws://127.0.0.1:9443/v1/racp/ws (transmis via SSH). Pour un hôte que vous avez démarré vous-même ; l'installation SSH ci-dessous s'en charge pour vous.",
      ...
      "sshTitle": "Installation sur un serveur (SSH)",
      "sshBody": "PI-Desktop installe pi-host sur une machine à laquelle vous accédez déjà par ssh et maintient un tunnel en boucle locale vers elle. Votre propre configuration ssh et votre agent s'appliquent ; un mot de passe de connexion peut remplacer une clé.",
      "sshHost": "Hôte SSH",
      "sshHostDesc": "Nom d'hôte ou adresse, exactement tel que ssh le reçoit.",
      "sshHostPlaceholder": "build-box.local",
      "sshUser": "Utilisateur",
      "sshUserDesc": "Utilisateur de connexion ; laissez vide pour utiliser votre nom d'utilisateur local.",
      "sshPort": "Port SSH",
      "sshPortDesc": "Laissez vide pour la valeur par défaut de ssh (22).",
      "sshIdentityFile": "Fichier d'identité",
      "sshIdentityFileDesc": "Chemin de la clé privée ; laissez vide pour que l'agent et ~/.ssh/config décident.",
      "sshAuthMode": "Authentification",
      "sshAuthModeDesc": "Utilisez votre propre clé SSH ou agent, ou authentifiez-vous par mot de passe.",
      "sshAuthKey": "Clé SSH",
      "sshAuthPassword": "Mot de passe",
      "sshPassword": "Mot de passe",
      "sshPasswordDesc": "Transmis au client ssh par un assistant askpass, jamais sur la ligne de commande.",
      "sshPasswordPlaceholder": "Votre mot de passe de connexion",
      "sshShowPassword": "Afficher le mot de passe",
      "sshHidePassword": "Masquer le mot de passe",
      "sshPasswordStored": "Enregistré dans le trousseau du système pour que cet hôte se reconnecte après un redémarrage.",
      "sshAction": "Installer et apparier",
      "sshActionHint": "Installe pi-host sur l'hôte et l'apparie à ce bureau.",
      "sshRunning": "Installation…",
      "sshSucceeded": "{{label}} installé et apparié.",
