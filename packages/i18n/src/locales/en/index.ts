...
sklm: {
    ...
    remoteHosts: {
      ...
      pairBody: "For a pi-host you already run yourself: paste its RACP URL and the pairing token from its startup output.",
      pair: "Pair",
      pairing: "Pairing…",
      pairAction: "Add",
      ...
      fieldUrl: "RACP URL",
      fieldUrlDesc:
        "The pi-host loopback endpoint, e.g. ws://127.0.0.1:9443/v1/racp/ws (forwarded over SSH). For a host you started yourself; the SSH install below does this for you.",
      ...
      sshTitle: "Install on a server (SSH)",
      sshBody:
        "PI-Desktop installs pi-host on a machine you already reach with ssh and keeps a loopback tunnel to it. Your own ssh configuration and agent apply; a login password can be used instead of a key.",
      sshHost: "SSH host",
      sshHostDesc: "Host name or address, exactly as ssh receives it.",
      sshHostPlaceholder: "build-box.local",
      sshUser: "User",
      sshUserDesc: "Login user; leave empty to use your local user name.",
      sshPort: "SSH port",
      sshPortDesc: "Leave empty for the ssh default (22).",
      sshIdentityFile: "Identity file",
      sshIdentityFileDesc:
        "Private key path; leave empty to let the agent and ~/.ssh/config decide.",
      sshAuthMode: "Authentication",
      sshAuthModeDesc: "Use your own SSH key or agent, or authenticate with a password.",
      sshAuthKey: "SSH key",
      sshAuthPassword: "Password",
      sshPassword: "Password",
      sshPasswordDesc: "Sent to the ssh client through an askpass helper, never on the command line.",
      sshPasswordPlaceholder: "Your login password",
      sshShowPassword: "Show password",
      sshHidePassword: "Hide password",
      sshPasswordStored: "Saved in the OS keychain so this host reconnects after a restart.",
      sshAction: "Install and pair",
      sshActionHint: "Installs pi-host on the host and pairs it with this desktop.",
      sshRunning: "Installing…",
      sshSucceeded: "{{label}} installed and paired.",
