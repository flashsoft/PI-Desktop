...
sklm: {
    ...
    "remoteHosts": {
      ...
      "pairBody": "Para un pi-host que ya ejecuta usted mismo: pegue su URL de RACP y el token de emparejamiento de su salida de inicio.",
      "pair": "Emparejar",
      "pairing": "Emparejando…",
      "pairAction": "Añadir",
      ...
      "fieldUrlDesc": "Punto final de bucle de retorno de pi-host, p. ej. ws://127.0.0.1:9443/v1/racp/ws (reenviado por SSH). Para un host que usted mismo inició; la instalación SSH de abajo lo hace por usted.",
      ...
      "sshTitle": "Instalar en un servidor (SSH)",
      "sshBody": "PI-Desktop instala pi-host en una máquina a la que ya accede por ssh y mantiene un túnel de bucle de retorno hacia ella. Se aplican su propia configuración de ssh y su agente; también puede usar una contraseña de inicio de sesión en lugar de una clave.",
      "sshHost": "Host SSH",
      "sshHostDesc": "Nombre de host o dirección, exactamente como lo recibe ssh.",
      "sshHostPlaceholder": "build-box.local",
      "sshUser": "Usuario",
      "sshUserDesc": "Usuario de inicio de sesión; déjelo vacío para usar su nombre de usuario local.",
      "sshPort": "Puerto SSH",
      "sshPortDesc": "Déjelo vacío para el valor predeterminado de ssh (22).",
      "sshIdentityFile": "Archivo de identidad",
      "sshIdentityFileDesc": "Ruta de la clave privada; déjela vacía para que lo decidan el agente y ~/.ssh/config.",
      "sshAuthMode": "Autenticación",
      "sshAuthModeDesc": "Use su propia clave SSH o agente, o autentíquese con una contraseña.",
      "sshAuthKey": "Clave SSH",
      "sshAuthPassword": "Contraseña",
      "sshPassword": "Contraseña",
      "sshPasswordDesc": "Se entrega al cliente ssh mediante un ayudante askpass, nunca en la línea de comandos.",
      "sshPasswordPlaceholder": "Su contraseña de inicio de sesión",
      "sshShowPassword": "Mostrar contraseña",
      "sshHidePassword": "Ocultar contraseña",
      "sshPasswordStored": "Se guarda en el llavero del sistema para que este host se reconecte tras un reinicio.",
      "sshAction": "Instalar y emparejar",
      "sshActionHint": "Instala pi-host en el host y lo empareja con este escritorio.",
      "sshRunning": "Instalando…",
      "sshSucceeded": "{{label}} instalado y emparejado.",
