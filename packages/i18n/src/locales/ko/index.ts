...
sklm: {
    ...
    remoteHosts: {
      ...
      pairTitle: "새 호스트 페어링",
      pairBody: "직접 실행 중인 pi-host라면: RACP URL과 시작 출력의 페어링 토큰을 붙여 넣으세요.",
      pair: "페어링",
      pairing: "페어링 중…",
      pairAction: "추가",
      ...
      fieldUrl: "RACP URL",
      fieldUrlDesc:
        "pi-host의 루프백 엔드포인트, 예: ws://127.0.0.1:9443/v1/racp/ws (SSH로 포워딩). 직접 시작한 호스트용이며, 아래 SSH 설치가 대신 처리합니다.",
      fieldPairingToken: "페어링 토큰",
      fieldPairingTokenDesc:
        "pi-host 부트스트랩 출력의 일회용 ppt1.* 토큰. 페어링 시 소비됩니다.",
      sshTitle: "서버에 설치(SSH)",
      sshBody:
        "PI-Desktop은 이미 ssh로 접속할 수 있는 머신에 pi-host를 설치하고 루프백 터널을 유지합니다. 직접 가진 ssh 설정과 에이전트가 그대로 적용되며, 키 대신 로그인 비밀번호를 사용할 수도 있습니다.",
      sshHost: "SSH 호스트",
      sshHostDesc: "ssh가 받는 그대로의 호스트 이름 또는 주소입니다.",
      sshHostPlaceholder: "build-box.local",
      sshUser: "사용자",
      sshUserDesc: "로그인 사용자입니다. 비워 두면 로컬 사용자 이름을 사용합니다.",
      sshPort: "SSH 포트",
      sshPortDesc: "비워 두면 ssh 기본값(22)을 사용합니다.",
      sshIdentityFile: "ID 파일",
      sshIdentityFileDesc: "개인 키 경로입니다. 비워 두면 에이전트와 ~/.ssh/config가 결정합니다.",
      sshAuthMode: "인증",
      sshAuthModeDesc: "직접 가진 SSH 키나 에이전트를 사용하거나 비밀번호로 인증합니다.",
      sshAuthKey: "SSH 키",
      sshAuthPassword: "비밀번호",
      sshPassword: "비밀번호",
      sshPasswordDesc: "askpass 도우미를 통해 ssh 클라이언트로 전달되며 명령줄에는 나타나지 않습니다.",
      sshPasswordPlaceholder: "로그인 비밀번호",
      sshShowPassword: "비밀번호 표시",
      sshHidePassword: "비밀번호 숨기기",
      sshPasswordStored: "OS 키체인에 저장되어 다시 시작한 뒤에도 이 호스트가 다시 연결됩니다.",
      sshAction: "설치 및 페어링",
      sshActionHint: "호스트에 pi-host를 설치하고 이 데스크톱과 페어링합니다.",
      sshRunning: "설치 중…",
      sshSucceeded: "{{label}} 설치 및 페어링됨.",
