...
export const de = {
  ...
  "topbar": {
    "copyBranch": "Branch „{{branch}}“ kopieren",
    "copied": "Kopiert",
    "openLocation": "Ort öffnen",
    "openWith": "Mit {{name}} öffnen",
    "noOpenLocationApps": "Keine unterstützten Apps gefunden",
  },
  "chat": {
...
sklm: {
    ...
    "remoteHosts": {
      ...
      "pairBody": "Für einen pi-host, den Sie selbst betreiben: RACP-URL und den Kopplungstoken aus seiner Startausgabe einfügen.",
      "pair": "Koppeln",
      "pairing": "Koppelt…",
      ...
      "fieldUrl": "RACP-URL",
      "fieldUrlDesc": "Der Loopback-Endpunkt von pi-host, z. B. ws://127.0.0.1:9443/v1/racp/ws (über SSH weitergeleitet). Für einen Host, den Sie selbst gestartet haben; die SSH-Installation unten erledigt das für Sie.",
      ...
      "sshTitle": "Installation auf einem Server (SSH)",
      "sshBody": "PI-Desktop installiert pi-host auf einem Rechner, den Sie bereits per ssh erreichen, und hält einen Loopback-Tunnel dorthin. Ihre eigene ssh-Konfiguration und Ihr Agent gelten; statt eines Schlüssels kann auch ein Anmeldepasswort verwendet werden.",
      "sshHost": "SSH-Host",
      "sshHostDesc": "Hostname oder Adresse, genau so, wie ssh sie erhält.",
      "sshHostPlaceholder": "build-box.local",
      "sshUser": "Benutzer",
      "sshUserDesc": "Anmeldebenutzer; leer lassen, um Ihren lokalen Benutzernamen zu verwenden.",
      "sshPort": "SSH-Port",
      "sshPortDesc": "Leer lassen für den ssh-Standard (22).",
      "sshIdentityFile": "Identitätsdatei",
      "sshIdentityFileDesc": "Pfad zum privaten Schlüssel; leer lassen, damit der Agent und ~/.ssh/config entscheiden.",
      "sshAuthMode": "Authentifizierung",
      "sshAuthModeDesc": "Verwenden Sie Ihren eigenen SSH-Schlüssel oder Agent — oder authentifizieren Sie sich mit einem Passwort.",
      "sshAuthKey": "SSH-Schlüssel",
      "sshAuthPassword": "Passwort",
      "sshPassword": "Passwort",
      "sshPasswordDesc": "Wird dem ssh-Client über einen askpass-Helfer übergeben, nie auf der Kommandozeile.",
      "sshPasswordPlaceholder": "Ihr Anmeldepasswort",
      "sshShowPassword": "Passwort anzeigen",
      "sshHidePassword": "Passwort verbergen",
      "sshPasswordStored": "Im Schlüsselbund des Betriebssystems gespeichert, damit sich dieser Host nach einem Neustart wieder verbindet.",
      "sshAction": "Installieren und koppeln",
      "sshActionHint": "Installiert pi-host auf dem Host und koppelt ihn mit diesem Desktop.",
      "sshRunning": "Wird installiert…",
      "sshSucceeded": "{{label}} installiert und gekoppelt.",
